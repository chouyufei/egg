...
Component({
  ...
  data: { cover: '', statusLabel: '', statusCls: '', kindLabel: '', kindCls: '', kindBidLabel: '报价', priceHint: '起 ¥', distText: '', distNear: false },
  observers: {
    r(r) {
      if (!r) return;
      const labels = { auctioning: '报价中', sold: '已成交', failed: '未成交', cancelled: '已取消', draft: '草稿' };
