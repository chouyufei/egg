<template>
  <div>
    ...
    <div class="stat-grid">
      ...
      <div class="stat"><div class="v">{{ stats.activeAuctions }}</div><div class="l">报价中</div></div>
    ...
    <div class="admin-card" style="margin-top: 24px;">
      ...
      <ul style="line-height: 2; color: #555;">
        <li>每次加价 ≥ <b>2 元</b>；最后 5 分钟有报价 → 自动延时 5 分钟（最多 3 次）</li>
        <li>养殖场 <b>1000 元</b> 品质保证金；采购商 <b>200 元</b> 履约保证金（同时仅冻结 1 笔）</li>
